function(cargo_build)
    ...
    cmake_parse_arguments(CARGO "" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})
    message(STATUS "SET Cargo project: ${CARGO_NAME}: ${CARGO_SOURCE_DIR}")
    ...
    set_target_properties(${CARGO_NAME} PROPERTIES IMPORTED_LOCATION ${LIB_FILE} INTERFACE_INCLUDE_DIRECTORIES ${CARGO_INCLUDE_DIRECTORIES})
endfunction()